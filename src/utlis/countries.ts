...
// Helper functions for working with countries data
...
export const findCountriesByName = (searchTerm: string): CountryInfo[] => {
  return countries.filter((country) => country.name.toLowerCase().includes(searchTerm.toLowerCase()));
};

export const sortCountriesByName = (): CountryInfo[] => {
