  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger asChild>
        <button className="group inline-flex cursor-pointer items-center gap-x-2 rounded-lg bg-black px-2.5 py-2 font-satoshi-medium text-xs text-white disabled:cursor-not-allowed md:px-3.5 md:text-sm">
          Filter
